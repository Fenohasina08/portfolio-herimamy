            ...
            <AnimateOnScroll key={project.id} direction="up" delay={150 + index * 80}>
              <div className="flex flex-col overflow-hidden card-terminal group">
                ...
                <div className="flex flex-col flex-1 p-4">
                  ...
                  <p className="flex-1 mb-4 text-xs leading-relaxed" style={{ color: 'var(--body)' }}>
                    {project.description}
                  </p>
                  ...
                  {project.deployed ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 py-2 text-xs font-medium transition-all rounded-lg"
                      style={{
